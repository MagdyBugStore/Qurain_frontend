...
export default function BookingConfirmationPage({ params }: { params: { id: string } }) {
  ...
  const handleConfirm = () => {
    // Navigate to technical check page
    router.push(`/technical-check/${params.id}`)
  }

  return (
    <>
      <Header />
      <main className="flex-grow flex flex-col md:flex-row items-center justify-center p-6 gap-8 bg-background-light dark:bg-background-dark">
        {/* Booking Confirmation */}
        <div className="w-full max-w-lg bg-surface-light dark:bg-surface-dark rounded-xl shadow-lg border border-slate-200 dark:border-[#393528] overflow-hidden flex flex-col h-fit">
          ...
          <div className="p-6 flex flex-col gap-6">
            ...
            <div className="flex gap-4 p-4 rounded-lg bg-slate-50 dark:bg-[#2c281e] border border-slate-100 dark:border-[#393528]">
              <div
                ...
                style={{
                  backgroundImage:
                    "url('https://lh3.googleusercontent.com/aida-public/AB6AXuCkDFBkifetIo78bsieqw3UAdhq2uPgwDQsowor-VVHm7Xl7vHEIgOl29aEbP9fnuuVp9M-7n2f1YBs4HQHVHZOscKvJHQaCO2w0cxU9sAOk8uUvI1MrsqHzSfRrj-moHVyIGQvgszaILg8cdPFFMoYHp78ihjt2Md2_iPi44C4R8Xn4KPAWhwMAkhzLjGVSr8Mvtql6jQuFbZhcfxOZStY7Tr1tmAoP2ImHHkilvdLj4Jzqa_KXDr_29WfuWPj67zPEzLkV9jFSb5G')",
                }}
              ></div>
              <div className="flex flex-col justify-center">
                <h3 className="text-slate-900 dark:text-white font-bold text-lg">الشيخ أحمد المصري</h3>
          ...
          <div className="p-6 pt-0 flex gap-3">
            <button
              ...
              className="flex-1 bg-primary hover:bg-primary-hover disabled:bg-gray-400 disabled:cursor-not-allowed text-[#181611] font-bold py-3 px-4 rounded-lg transition-colors flex items-center justify-center gap-2"
            >
        ...
        <div className="w-full max-w-lg bg-surface-light dark:bg-surface-dark rounded-xl shadow-lg border border-slate-200 dark:border-[#393528] overflow-hidden flex flex-col justify-center items-center h-fit min-h-[500px] text-center p-8 relative hidden md:flex">
          <div
          ...
          <div className="relative z-10 flex flex-col items-center gap-6 max-w-sm">
            ...
            <div className="w-full bg-slate-50 dark:bg-[#2c281e] rounded-lg p-4 border border-slate-100 dark:border-[#393528] flex flex-col gap-2">
              ...
              <p className="text-xl font-mono font-bold text-slate-900 dark:text-white tracking-widest">#QO-8492</p>
            </div>
          </div>
        </div>
      </main>
