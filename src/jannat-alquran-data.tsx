...
export const TESTIMONIALS: Testimonial[] = [
  {
    name: "Sarah Johnson",
    nameAr: "سارة جونسون",
    text: "The teachers are incredibly patient and knowledgeable. I've learned so much in just a few months.",
    textAr: "المعلمون صبورون للغاية ومطلعون. لقد تعلمت الكثير في غضون بضعة أشهر فقط.",
    location: "London, UK",
  ...
  },
  {
    name: "Mohammed Ali",
    nameAr: "محمد علي",
    text: "Excellent platform for learning Quran. The flexible scheduling works great for my busy life.",
    textAr: "منصة ممتازة لتعلم القرآن. الجدول الزمني المرن يعمل بشكل رائع مع حياتي المزدحمة.",
  ...
  },
  {
    name: "Aisha Khan",
    nameAr: "عائشة خان",
    text: "My children love their teacher. The interactive methods keep them engaged.",
    textAr: "أطفالي يحبون معلمهم. الأساليب التفاعلية تبقيهم مشاركين.",
